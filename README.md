...
```
flake.nix          entry point (inputs, username/hostname, darwinConfiguration)
...
- Terminals: [Ghostty](home/ghostty.nix), [Kitty](home/kitty.nix), [Alacritty](home/alacritty.nix) — all themed **Gruvbox Dark Hard** with IoskeleyMono Nerd Font
...
- [Helix](home/helix.nix) — primary editor, Gruvbox theme, LSPs for Nix/Go/Python/Lua/TS/Java
- [Neovim](home/neovim.nix) — NvChad-based config, set as `$EDITOR`

## Window management

- [AeroSpace](home/aerospace.nix) — tiling window manager, vim-style keybindings (`alt+hjkl`)
- [JankyBorders](home/borders.nix) — active window border highlight
